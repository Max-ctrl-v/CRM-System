...
const PIPELINE_STAGES = [
  ...
  {
    key: 'MEETING_VEREINBART',
    label: 'Meeting vereinbart',
    color: '#06b6d4',
    colorEnd: '#22d3ee',
    bgLight: '#ecfeff',
    borderColor: '#a5f3fc',
    bgColumn: 'linear-gradient(180deg, #ecfeff 0%, #e0fcff 40%, #f0feff 100%)',
    iconBg: 'linear-gradient(135deg, #06b6d4, #22d3ee)',
    bgLightDark: 'rgba(6,182,212,0.12)',
    borderColorDark: 'rgba(6,182,212,0.25)',
    bgColumnDark: 'linear-gradient(180deg, rgba(6,182,212,0.08) 0%, rgba(6,182,212,0.04) 40%, #13161f 100%)',
  },
  {
    key: 'VERHANDLUNG',
    label: 'Verhandlung',
