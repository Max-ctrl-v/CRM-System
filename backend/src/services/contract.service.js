...
async function create(data, userId) {
  ...
  const contract = await prisma.contract.create({
    data: {
      ...
      verguetungsVariante: data.verguetungsVariante || 'A',
      verguetungsSatzB: data.verguetungsSatzB ?? 12,
      tagessatz: data.tagessatz ?? 1500,
      stundensatz: data.stundensatz ?? 200,
      haftungProSchadensfall: data.haftungProSchadensfall ?? 50000,
      haftungProKalenderjahr: data.haftungProKalenderjahr ?? 250000,
